var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var global$C = global$D; // eslint-disable-next-line es/no-object-defineproperty -- safe

	var defineProperty$3 = Object.defineProperty;

	var setGlobal$3 = function (key, value) {
	  try {
	    defineProperty$3(global$C, key, {
	      value: value,
	      configurable: true,
	      writable: true
	    });
	...
	var callBind = bind$5 && bind$5.bind(call$f);
	...
	var Object$5 = global$z.Object; // `ToObject` abstract operation
	...
	var fails$h = fails$i; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	...
	var fails$g = fails$i; // Detect IE8's incomplete defineProperty implementation
	...
	var TypeError$d = global$u.TypeError; // `Assert: Type(argument) is Object`
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$d(fn = input.toString) && !isObject$5(val = call$d(fn, input))) return val;
	  if (isCallable$d(fn = input.valueOf) && !isObject$5(val = call$d(fn, input))) return val;
	  if (pref !== 'string' && isCallable$d(fn = input.toString) && !isObject$5(val = call$d(fn, input))) return val;
	...
	var TO_PRIMITIVE = wellKnownSymbol$f('toPrimitive'); // `ToPrimitive` abstract operation
	...
	var TypeError$9 = global$o.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	if (NATIVE_WEAK_MAP || shared$1.state) {
	  ...
	  set = function (it, metadata) {
	    if (hasOwn$9(it, STATE)) throw new TypeError$8(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var EXISTS = hasOwn$8(FunctionPrototype$1, 'name'); // additional protection from minified / mangled / dropped function names
	...
	var Object$3 = global$k.Object; // ES3 wrong here
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  redefine$8(Object.prototype, 'toString', toString$6, {
	    unsafe: true
	  });
	}
	...
	var anObject$c = anObject$e; // `RegExp.prototype.flags` getter implementation
	...
	var getFlags = uncurryThis$f(regExpFlags);
	...
	if (NOT_GENERIC || INCORRECT_NAME) {
	  redefine$7(RegExp.prototype, TO_STRING, function toString() {
	    ...
	    var rf = R.flags;
	    var f = $toString$2(rf === undefined && isPrototypeOf$1(RegExpPrototype$1, R) && !('flags' in RegExpPrototype$1) ? getFlags(R) : rf);
	    return '/' + p + '/' + f;
	  }, {
	    unsafe: true
	  });
	...
	var split$3 = uncurryThis$e(''.split); // fallback for non-array-like ES3 and non-enumerable old V8 strings
	...
	var indexedObject = fails$d(function () {
	  ...
	  return classof$5(it) == 'String' ? split$3(it, '') : Object$2(it);
	} : Object$2;
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$4 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$6(O, P)) return createPropertyDescriptor$3(!call$b(propertyIsEnumerableModule$1.f, O, P), O[P]);
	};
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  for (key in O) !hasOwn$5(hiddenKeys$2, key) && hasOwn$5(O, key) && push$4(result, key); // Don't enum bug & hidden keys
	...
	var concat$2 = uncurryThis$c([].concat); // all object keys, includes non-enumerable and symbols
	...
	*/
	...
	var $$4 = _export;
	var exec$3 = regexpExec$2; // `RegExp.prototype.exec` method
	...
	var call$9 = FunctionPrototype.call; // eslint-disable-next-line es/no-reflect -- safe

	var functionApply = typeof Reflect == 'object' && Reflect.apply || (bind$4 ? call$9.bind(apply$1) : function () {
	...
	var fixRegexpWellKnownSymbolLogic = function (KEY, exec, FORCED, SHAM) {
	  ...
	  if (!DELEGATES_TO_SYMBOL || !DELEGATES_TO_EXEC || FORCED) {
	    ...
	    redefine$5(RegExpPrototype, SYMBOL, methods[1]);
	  }
	...
	fixRegExpWellKnownSymbolLogic$1('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  function replace(searchValue, replaceValue) {
	    ...
	    return replacer ? call$7(replacer, searchValue, O, replaceValue) : call$7(nativeReplace, toString$2(O), searchValue, replaceValue);
	...
	if (!isCallable$4(IteratorPrototype$2[ITERATOR$6])) {
	...
	var defineIterator$2 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (IterablePrototype[ITERATOR$5] !== defaultIterator) {
	    redefine$3(IterablePrototype, ITERATOR$5, defaultIterator, {
	      name: DEFAULT
	    });
	  }
	...
	var nativeUrl = !fails$4(function () {
	...
	var bind$3 = uncurryThis$5(uncurryThis$5.bind); // optional / simple context binding
	...
	var concat = uncurryThis$4([].concat); // `Object.assign` method
	...
	var getIterator$2 = function (argument, usingIterator) {
	  ...
	  if (aCallable(iteratorMethod)) return anObject$2(call$3(iteratorMethod, argument));
	...
	var Array$3 = global$7.Array; // `Array.from` method implementation
	...
	var URLSearchParamsState = function (init) {
	  ...
	  if (init !== undefined) {
	    if (isObject$2(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$1(init, 0) === '?' ? stringSlice$1(init, 1) : init : $toString$1(init));
	  }
	};
	  ...
	  parseObject: function (object) {
	    ...
	    if (iteratorMethod) {
	      ...
	      while (!(step = call$1(next, iterator)).done) {
	        ...
	        if ((first = call$1(entryNext, entryIterator)).done || (second = call$1(entryNext, entryIterator)).done || !call$1(entryNext, entryIterator).done) throw TypeError$3('Expected sequence with length 2');
	        push$1(this.entries, {
